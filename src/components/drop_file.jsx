...
import { dragRelease } from "../utlity";
const Drop_file = () => {
    return <>
        <div
            onDragLeave={dragRelease}
            className="my-4 rounded-lg border-2 border-dashed border-black w-3/4 py-16 mx-auto flex flex-row justify-center items-center"
        >
